...
import { getDatabase, getPageSlug, getPageTitle } from 'src/lib/notion'
            ...
            return (
              <li key={post.id} className={styles.post}>
                <h3 className={styles.postTitle}>
                  <Link href={`/${getPageSlug(post)}`}>{getPageTitle(post)}</Link>
                </h3>

                <p className={styles.postDescription}>{date}</p>
                <Link href={`/${getPageSlug(post)}`}>Read post →</Link>
              </li>
            )
          })}
        </ol>
